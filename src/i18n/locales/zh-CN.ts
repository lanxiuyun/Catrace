export default {
  ...
  settings: {
    ...
    agent: {
      ...
      nameKimi: 'Kimi',
      eventsTitle: '事件通知策略',
      eventsDesc: '默认只对「需要你回来」的事件常驻；可按事件改成不通知 / 自动消失 / 常驻。权限请求目前只提醒，不在 Catrace 里代批',
      modeOff: '不通知',
      modeAuto: '自动消失',
      modeSticky: '常驻',
      eventSessionStart: '会话开始',
      eventUserPromptSubmit: '开始思考（也用于自动销待办）',
      eventStop: '任务完成，等你回复',
      eventStopFailure: '任务出错 / 异常',
      eventNotification: '助手需要你关注',
      eventPermissionRequest: '等待你批准工具',
      soundTitle: '提示音',
  ...
  agent: {
    ...
    bodyPermission: '有工具调用在等你批准（请回终端操作）',
    bodyDefault: '状态已更新',
