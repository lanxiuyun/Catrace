export default {
  ...
  settings: {
    ...
    agent: {
      ...
      eventsDesc: 'By default only "needs you back" events stick; change per event to Off / Auto-hide / Sticky. Permission requests notify only — approve still in the terminal',
      modeOff: 'Off',
      modeAuto: 'Auto-hide',
      modeSticky: 'Sticky',
      eventSessionStart: 'Session start',
      eventUserPromptSubmit: 'Thinking (also auto-dismisses sticky)',
      eventStop: 'Task finished, waiting for you',
      eventStopFailure: 'Task failed / error',
      eventNotification: 'Assistant needs you',
      eventPermissionRequest: 'Waiting for tool approval',
      soundTitle: 'Sound',
  ...
  agent: {
    ...
    titlePermission: 'AI Assistant Needs Approval',
    ...
    bodyPermission: 'A tool call is waiting for approval (approve in the terminal)',
