export default {
  ...
  settings: {
    ...
    agent: {
      ...
      eventsDesc: '"Auto-hide" dismisses itself; "Sticky" stays until you close it — for completions and waiting-for-input alerts you don\'t want to miss',
      modeOff: 'Off',
      modeAuto: 'Auto-hide',
      modeSticky: 'Sticky',
      eventSessionStart: 'Session start',
      eventUserPromptSubmit: 'Thinking',
      eventStop: 'Task finished',
      eventStopFailure: 'Task failed',
      eventNotification: 'Assistant notice',
      soundTitle: 'Sound',
  ...
  agent: {
    ...
    bodyPending: '{n} Claude Code sessions need your attention',
