export default {
  ...
  mediaWhitelist: {
    ...
    subtitle: 'When audio is playing, focused window processes in this list are not counted as active',
    ...
    placeholder: 'e.g.\nsvchost.exe\nexplorer.exe\n# this is a comment\nruntimebroker.exe',
    hint: 'One process name per line (case-insensitive).\nLines starting with # are ignored.\nProcesses in this list will not be counted as active even if they are playing audio or focused.',
  },
  debug: {
