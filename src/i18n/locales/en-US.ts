export default {
  ...
  settings: {
    ...
    agent: {
      ...
      eventsDesc: 'By default only "needs you back" events stick; change per event to Off / Auto-hide / Sticky. Permission requests pop an approval card — approve or deny right in Catrace',
      modeOff: 'Off',
      modeAuto: 'Auto-hide',
      modeSticky: 'Sticky',
