...
const links: LinkItem[] = [
  {
    ...
    iconStyle: 'background:var(--ct-surface-2);color:var(--ct-text);',
  },
  {
    url: 'https://github.com/lanxiuyun/Catrace/releases',
    title: t('settings.links.changelogTitle'),
    desc: t('settings.links.changelogDesc'),
    icon: 'M12 2L2 7l10 5 10-5-10-5z M2 17l10 5 10-5 M2 12l10 5 10-5',
    iconStyle: 'background:var(--ct-info-soft);color:var(--ct-info);',
  },
  {
    url: 'https://github.com/lanxiuyun/Catrace/issues',
    title: t('settings.links.issuesTitle'),
    desc: t('settings.links.issuesDesc'),
    icon: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z',
    iconStyle: 'background:var(--ct-warning-soft);color:var(--ct-warning);',
  },
  {
    title: t('debug.openLogsDir'),
    desc: t('settings.links.logsDesc'),
    icon: 'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2v6h6 M16 13H8 M16 17H8 M10 9H8',
    iconStyle: 'background:var(--ct-accent-softer);color:var(--ct-accent);',
    onClick: async () => {
      try {
        await openLogsDir()
      } catch (e: any) {
...
.link-item {
  ...
  border: 0.0625rem solid var(--ct-accent-softer);
